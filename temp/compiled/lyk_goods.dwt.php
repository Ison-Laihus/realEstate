...
<div id="lyk_good">
     ...
     <div id="lyk_good_img">
         ...
         <img id="lyk_show_pic" src="<?php echo $this->_var['goods']['goods_img']; ?>" alt="<?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?>"/>
         <?php else: ?>
         <img id="lyk_show_pic" src="<?php echo $this->_var['goods']['goods_img']; ?>" alt="<?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?>"/>
         <?php endif; ?>
         
            <?php echo $this->fetch('library/lyk_goods_gallery.lbi'); ?>
         
         
    </div>
    
    
         <form id="lyk_textInfo" action="javascript:addToCart(<?php echo $this->_var['goods']['goods_id']; ?>)" method="post" name="ECS_FORMBUY">
              <p id="lyk_good_name"><?php echo $this->_var['goods']['goods_style_name']; ?></p>
              <ul id="lyk_good_msg">
          ...
          <?php endif; ?>
            ...
            <?php endif; ?>
              ...
              <?php if ($this->_var['goods']['is_shipping']): ?>
                    ...
                    <li id="lyk_good_msg_item"><?php echo $this->_var['lang']['goods_free_shipping']; ?><br /></li>
...
{insert_script files="common.js, transport.js, utils.js"}
